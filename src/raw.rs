...
impl ::protobuf::Enum for DisplayType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<DisplayType> {
        match str {
            "Visible" => ::std::option::Option::Some(DisplayType::Visible),
            "Snapshot" => ::std::option::Option::Some(DisplayType::Snapshot),
            "Hidden" => ::std::option::Option::Some(DisplayType::Hidden),
            "Placeholder" => ::std::option::Option::Some(DisplayType::Placeholder),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for Alliance {
    ...
    fn from_str(str: &str) -> ::std::option::Option<Alliance> {
        match str {
            "Self" => ::std::option::Option::Some(Alliance::Self_),
            "Ally" => ::std::option::Option::Some(Alliance::Ally),
            "Neutral" => ::std::option::Option::Some(Alliance::Neutral),
            "Enemy" => ::std::option::Option::Some(Alliance::Enemy),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for CloakState {
    ...
    fn from_str(str: &str) -> ::std::option::Option<CloakState> {
        match str {
            "CloakedUnknown" => ::std::option::Option::Some(CloakState::CloakedUnknown),
            "Cloaked" => ::std::option::Option::Some(CloakState::Cloaked),
            "CloakedDetected" => ::std::option::Option::Some(CloakState::CloakedDetected),
            "NotCloaked" => ::std::option::Option::Some(CloakState::NotCloaked),
            "CloakedAllied" => ::std::option::Option::Some(CloakState::CloakedAllied),
            _ => ::std::option::Option::None
        }
    }
