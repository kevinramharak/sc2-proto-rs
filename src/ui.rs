...
pub mod action_control_group {
    ...
    impl ::protobuf::Enum for ControlGroupAction {
        ...
        fn from_str(str: &str) -> ::std::option::Option<ControlGroupAction> {
            match str {
                "Recall" => ::std::option::Option::Some(ControlGroupAction::Recall),
                "Set" => ::std::option::Option::Some(ControlGroupAction::Set),
                "Append" => ::std::option::Option::Some(ControlGroupAction::Append),
                "SetAndSteal" => ::std::option::Option::Some(ControlGroupAction::SetAndSteal),
                "AppendAndSteal" => ::std::option::Option::Some(ControlGroupAction::AppendAndSteal),
                _ => ::std::option::Option::None
            }
        }
...
pub mod action_select_idle_worker {
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "Set" => ::std::option::Option::Some(Type::Set),
                "Add" => ::std::option::Option::Some(Type::Add),
                "All" => ::std::option::Option::Some(Type::All),
                "AddAll" => ::std::option::Option::Some(Type::AddAll),
                _ => ::std::option::Option::None
            }
        }
...
pub mod action_multi_panel {
    ...
    impl ::protobuf::Enum for Type {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Type> {
            match str {
                "SingleSelect" => ::std::option::Option::Some(Type::SingleSelect),
                "DeselectUnit" => ::std::option::Option::Some(Type::DeselectUnit),
                "SelectAllOfType" => ::std::option::Option::Some(Type::SelectAllOfType),
                "DeselectAllOfType" => ::std::option::Option::Some(Type::DeselectAllOfType),
                _ => ::std::option::Option::None
            }
        }
